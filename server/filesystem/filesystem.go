...
//
// The returned handle enforces per-server disk quotas on every write (SFTP and other
// streaming writers). Without this wrap, only the open-time preflight check ran.
